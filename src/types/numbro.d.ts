...
declare function numbro(value?: unknown): numbro.Numbro;

declare namespace numbro {

    export const version: string;

    export function isNumbro(value: unknown): boolean;
    ...
    export function defaultFormat(): Record<string, never>;

    export function setDefaults(format: Format | string): void;

    export function defaultCurrencyFormat(newFormat: string): Record<string, never>;
